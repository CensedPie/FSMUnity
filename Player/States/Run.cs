...
{
    public Run(PlayerController playerController) : base(playerController)
    {
    ...
    {
        base.Enter();
        //m_AnimComponent.SetBool("Run", true);
    }
    ...
    public override void HandleInput()
    {
        ...
        {
            m_EventTransition.Invoke(new Walk(m_PlayerController), true);
        }
    ...
    public override void Update()
    {
        ...
        m_Velocity.x = m_Direction.x * m_RunSpeed;
        m_Velocity.z = m_Direction.z * m_RunSpeed;
    ...
    {
        base.Exit();
        // Exit the run animation state.
        //m_AnimComponent.SetBool("Run", false);
    }
}
